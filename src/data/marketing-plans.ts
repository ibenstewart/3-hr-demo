...
export const marketingPlans: MarketingPlan[] = [
  ...
  },
  {
    ...
    channels: [
      ...
      { name: 'Content & Thought Leadership', icon: 'file-text', fit: 'high', reason: 'Case studies and white papers demonstrate ROI to enterprise buyers. "Meridian Bank launched flights in 2 weeks" is the story.', roi: 3.8, cpa: '£45', incrementality: 65, efficiency: 'efficient' },
    ...
    tactics: [
      ...
      { id: 104, name: 'Case Study Marketing', category: 'Content', effort: 'medium', impact: 'high', description: 'Document every pilot partner\'s journey from signup to revenue. Enterprise buyers need proof, not promises.', firstSteps: ['Interview Meridian Bank pilot partner about launch experience', 'Quantify key metrics: time to launch, click-through rates, booking revenue', 'Create video case study + written case study + one-page PDF for sales'] },
    ...
    copyStudio: [
      ...
      { channel: 'email', channelLabel: 'Email', icon: 'mail', items: [
        { type: 'subject-line', text: 'Meridian Bank just launched flights. In 2 weeks.', variant: 'Social proof' },
    ...
    contentCalendar: {
      ...
      pieces: [
        ...
        { week: 2, title: 'Meridian Bank Case Study: 14 Days to Live Flights', format: 'blog', buyerStage: 'consideration', type: 'both', pillar: 'Case Studies & Proof', brief: 'Deep dive into Meridian Bank pilot. Timeline, setup process, launch metrics (12K searches week one, 3.2% conversion). Include screenshots of branded experience.' },
